...
onnx_to_c_types = {
    "FLOAT": "float",  # This is the most common
    "DOUBLE": "double",
}
...
def generateIOEntries(model, context):
    """
...
def build(
    ...
    generateIOEntries(model, context)
